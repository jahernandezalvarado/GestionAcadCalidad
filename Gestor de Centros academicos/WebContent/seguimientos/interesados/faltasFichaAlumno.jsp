...
<table width="85%" border="0" align="center" class="tablaListados">
  ...
  <tr class="tablaListados">
    ...
    <td colspan="2" class="tdDef">
    	<img  onmouseover="this.src='../imagenes/imprimirGr.png'" onmouseout="this.src='../imagenes/imprimirPe.png'" src="../imagenes/imprimirPe.png" width="30" height="30" onclick="window.open('../ImpFaltasEdiAluServlet?codInt=<%=codAlu%>&codEdi=<%=codEdi%>','_califAlu','');"/>
